-- Drop existing college_info table completely
DROP TABLE IF EXISTS public.college_info CASCADE;

-- Create fresh college_info table
...
DROP POLICY IF EXISTS "Anyone can view college info" ON public.college_info;
DROP POLICY IF EXISTS "Only super_admin can insert college info" ON public.college_info;
DROP POLICY IF EXISTS "Admins can insert college info" ON public.college_info;
DROP POLICY IF EXISTS "Only admins can update college info" ON public.college_info;
DROP POLICY IF EXISTS "Admins can update college info" ON public.college_info;
