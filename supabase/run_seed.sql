...
BEGIN
    ...
    INSERT INTO sections (name, department_id, year_id, academic_year_id, max_students) VALUEScontuinue
...
-- 2. Create these 3 test users:
--    - admin@jpmcollege.edu / Admin@123
--    - teacher@jpmcollege.edu / Teacher@123  
--    - student@jpmcollege.edu / Student@123
--
-- 3. After creating users, run these commands:
