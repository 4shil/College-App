    ...
    <AnimatedBackground>
      <View style={[styles.container, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 100 }]}>
        <View style={styles.header}>
          ...
          <Text style={[styles.headerTitle, { color: colors.textPrimary }]}>Notices & Updates</Text>
          <View style={{ width: 28 }} />
        </View>

        <Card style={styles.placeholder}>
          <Ionicons name="notifications" size={64} color={colors.textMuted} />
          <Text style={[styles.placeholderTitle, { color: colors.textPrimary }]}>Notices Module</Text>
          ...
          <Text style={[styles.placeholderDetails, { color: colors.textMuted }]}>
            Features: College notices, Department updates, Exam notifications, Event announcements, Holiday alerts
          </Text>
        </Card>
      </View>
    </AnimatedBackground>
