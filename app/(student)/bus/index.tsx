    ...
    <AnimatedBackground>
      <View style={[styles.container, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 100 }]}>
        ...
        <Card style={styles.placeholder}>
          <Ionicons name="bus" size={64} color={colors.textMuted} />
          <Text style={[styles.placeholderTitle, { color: colors.textPrimary }]}>Bus Module</Text>
          <Text style={[styles.placeholderSubtitle, { color: colors.textSecondary }]}>
            Manage bus selection and routes
          </Text>
          <Text style={[styles.placeholderDetails, { color: colors.textMuted }]}>
            Features: Bus selection, Route details, Arrival times, Payment alerts, Holiday schedules
          </Text>
        </Card>
      </View>
    </AnimatedBackground>
