    ...
    <AnimatedBackground>
      <View style={[styles.container, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 100 }]}>
        ...
        <Card style={styles.placeholder}>
          <Ionicons name="receipt" size={64} color={colors.textMuted} />
          <Text style={[styles.placeholderTitle, { color: colors.textPrimary }]}>Fees Module</Text>
          ...
          <Text style={[styles.placeholderDetails, { color: colors.textMuted }]}>
            Features: Fee structure, Payment status, Receipts, Dues details, Payment history
          </Text>
        </Card>
      </View>
    </AnimatedBackground>
