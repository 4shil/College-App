    ...
    <AnimatedBackground>
      <View style={[styles.container, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 100 }]}>
        ...
        <Card style={styles.placeholder}>
          <Ionicons name="ribbon" size={64} color={colors.textMuted} />
          <Text style={[styles.placeholderTitle, { color: colors.textPrimary }]}>Honors & Minor</Text>
          <Text style={[styles.placeholderSubtitle, { color: colors.textSecondary }]}>
            Select and track your minor choice
          </Text>
          <Text style={[styles.placeholderDetails, { color: colors.textMuted }]}>
            Features: Available minors, Submit selection, Approval status
          </Text>
        </Card>
      </View>
    </AnimatedBackground>
