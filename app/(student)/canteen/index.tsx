    ...
    <AnimatedBackground>
      <View style={[styles.container, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 100 }]}>
        ...
        <Card style={styles.placeholder}>
          ...
          <Text style={[styles.placeholderTitle, { color: colors.textPrimary }]}>Canteen Module</Text>
          <Text style={[styles.placeholderSubtitle, { color: colors.textSecondary }]}>
            Order food and manage tokens
          </Text>
          <Text style={[styles.placeholderDetails, { color: colors.textMuted }]}>
            Features: Daily menu, Pre-order tokens, Token history, Payment status, Availability updates
          </Text>
        </Card>
      </View>
    </AnimatedBackground>
