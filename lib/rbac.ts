...
export const PERMISSIONS = {
  ...
  RECEPTION_VIEW_ALL_ATTENDANCE: 'reception_view_all_attendance',
} as const;
...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  [ADMIN_ROLES.RECEPTION_ADMIN]: [
    ...
    PERMISSIONS.RECEPTION_VIEW_ALL_ATTENDANCE,
  ],
};
...
export const MODULE_ACCESS: Record<string, string[]> = {
  ...
  events: [ADMIN_ROLES.SUPER_ADMIN],
  'planner-diary': [ADMIN_ROLES.SUPER_ADMIN, ADMIN_ROLES.PRINCIPAL, ADMIN_ROLES.DEPARTMENT_ADMIN, ADMIN_ROLES.HOD],
  reception: [ADMIN_ROLES.SUPER_ADMIN, ADMIN_ROLES.RECEPTION_ADMIN],
  receptionAttendance: [ADMIN_ROLES.SUPER_ADMIN, ADMIN_ROLES.RECEPTION_ADMIN],
